...
export default {
  async fetch(
    ...
    if (!method) {
      const apiUrl = `https://animepahe.hellodhruvin.workers.dev/` as const;
      return WorkerResponse(
        {
          ...
          ep: "EPIsode ID",
          example: {
            "SEARCH-ANIME": `${apiUrl}?method=search&query=Words`,
            "FETCH-EPISODE-OF-A-SERIES": `${apiUrl}?method=series&session=5fe211d4-3cef-c32a-ab31-ec777f07fc5f&page=1`,
            "REQUEST-LINKS-OF-A-EPISODE": `${apiUrl}?method=episode&session=5fe211d4-3cef-c32a-ab31-ec777f07fc5f&ep=52f935732970bc1e1482d7e726b34fba1ffdbe040a55f9c9c03cfa0a20dff6ea`,
          },
        },
        "application/json",
      );
